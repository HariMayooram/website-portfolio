    ...
    <div className="absolute inset-0 grid lg:place-items-center px-4 sm:px-8 ">
      <div className="flex flex-col max-w-xl text-center justify-center ">
        <h1 className="font-bold text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight break-words">
          Hey there. This is <span className="name break-words">Harigovind R</span> (Hari)
        </h1>
        ...
        <p className="text-white mt-2 text-sm sm:text-base md:text-lg break-words">
          From full-stack applications to machine-learning experiments, I’m driven by a deep curiosity to understand, build, refine, and deliver meaningful solutions.
        </p>
        <button className="mx-auto mt-[8%] p-6 px-6 py-4 bg-[#124b50] hover:bg-[#69dbebbe] tomorrow-extrabold text-white rounded font-bold text-lg ">
              <a  href="mailto:harigov.raj@gmail.com" >HIRE ME</a>   </button>
...
<div className="fixed inset-0 -z-10 pointer-events-none">
  ...
  <h1 className="holtwood-one-sc-regular  text-4xl font-bold mt-[3%] mb-[5%] lg:mt-[1%] lg:mb-[1%] text-center w-full">ABOUT ME</h1>
    {/* Right Section: Image */}
    ...
    <div className="lg: w-1/3 items-end flex tomorrow-regular">
      Software Developer | ML / AI appreciator | Photography tyro | Bioinformatics and FinTech novice 
    </div>
    </div>
    {/* Left Section: About Me Content */}
      ...
      <p className="text-md mb-[2%]">
        As a software developer with a Master's degree in Computer Science from <span className="name"> DePaul University, Chicago. </span>
        I have a strong foundation in web and mobile development, complemented by hands-on experience in data analysis and applied machine learning.
        I approach development with structure and precision, prioritizing clean architecture, scalability, and performance.
  ...
  <main className="my-20 lg:mt-40">
      ...
      >
        <div className="">
          ...
          <h1 className="sticky top-0 holtwood-one-sc-regular text-4xl font-bold my-5">WORK <br />EXPERIENCE</h1>
          <div className="lg:ml-40">
            ...
            <div className="">
            <p className="text-lg lg:ml-102 mb-6 tomorrow-regular "> AltraDimension Technologies</p>
          ...
          <div className="lg:ml-40">
            ...
            <div className="">
            <p className="text-lg mb-6 tomorrow-regular lg:ml-102"> Bharat Electronics Limited</p>
          ...
          <div className="lg:ml-40">
            ...
            <p className="text-lg mb-6 tomorrow-regular lg:ml-102"> SHARP NGO</p>
  ...
  <main className="h-[80vh]">
          ...
          <h1 className="holtwood-one-sc-regular text-4xl font-bold mt-5 mb-15 mx-10 sm:mx-0">SKILLS</h1>
...
<div className=" absolute left-[-10%] z-10 h-[15%] w-[110%] rounded-b-[25%] shadow-[0_50px_50px_0px_rgba(0,0,0,0.7)] bg-animated-black">
