...
export default function FooterReveal() {
  ...
  return (
    ...
    >
      ...
      <div>
       <h1 className='changa-one-boldD text-4xl mt-[2%] text-[#2f9397] mb-4'> Fire a Message My Way</h1>
       <a className='skillsComp text-black' href="mailto:harigov.raj@gmail.com">harigov.raj@gmail.com</a>

       </div>
       <div className='h-full  flex flex-row justify-between items-end '>
        <div className='my-15 sm:my-3'>
          <Link href="/" className="yesteryear-regular text-4xl m-4">HG</Link>
        </div>


      <div className='tomorrow-regular invisible sm:visible'>
        <h1> Made by <span className='italic'>Harigovind R </span> </h1>
      </div>
      ...
      <div className='my-10 sm:my-0'>
        ...
        <a href="https://github.com/HariMayooram">
          <Image alt="github" className='h-8 w-8 m-2 hover:bg-brown ' src={gitH} />
        </a>
...
{/* <h1>HELLO THERE</h1>
      ...
      <h2 className="text-2xl font-bold">This is the footer reveal</h2>
      <p className="text-sm text-gray-400">Revealed smoothly as you scroll near bottom</p> */}
